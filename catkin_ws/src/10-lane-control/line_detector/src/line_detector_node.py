...
from duckietown_msgs.msg import (AntiInstagramTransform, BoolStamped, Segment, FSMState, SegmentList, Vector2D)
...
class LineDetectorNode(object):
    def __init__(self):
        ...
        self.sub_fsm = rospy.Subscriber("~mode", FSMState, self.cbFSM, queue_size=1)  ##???
